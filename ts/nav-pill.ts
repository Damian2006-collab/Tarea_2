(function () {
  ...
  const maybeList = nav.querySelector<HTMLUListElement>('ul');
  if (!maybeList) return;
  ...
  function movePillTo(target: HTMLElement): void {
  ...
  function placeInstantly(fn: () => void): void {
